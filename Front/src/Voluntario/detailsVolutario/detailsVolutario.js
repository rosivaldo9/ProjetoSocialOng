                ...
                <fieldset>
                    ...
                    <div className="card textForm">
                        ...
                        <div className="card-body">
                            ...
                            <Link to={`/profile/voluntario/editar/${Voluntario._id}`} className="btn btn-warning btn-lg mr-2">Editar </Link>
                            <Link to={`/profile/voluntario/remover/${Voluntario._id}`} className="btn btn-danger btn-lg">Remover </Link>
                        </div>
                    </div>
                </fieldset>
            </form>
